...
TARGET_RECOVERY_FSTAB := device/htc/pme/rootdir/etc/fstab.qcom
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/htc/pme/bluetooth
...
BOARD_SEPOLICY_DIRS += device/htc/pme/sepolicy
...
BOARD_EGL_CFG := device/htc/pme/egl.cfg
